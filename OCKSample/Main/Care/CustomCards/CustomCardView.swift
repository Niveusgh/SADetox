                ...
                */
                ...
                HStack(alignment: .center,
                    ...
                    Button(action: {
                        ...
                        CircularCompletionView(isComplete: viewModel.taskEvents.isFirstEventComplete, content: {
                    ...
                    Button(action: {
                        ...
                        RectangularCompletionView(isComplete: viewModel.taskEvents.isFirstEventComplete, content: {
                                Image(systemName: "checkmark")
                                    .resizable()
                                    .padding()
                                    .frame(width: 50, height: 50)
